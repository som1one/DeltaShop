...
import { byHouse, type Product } from "@/lib/products";

/**
 * Hero variant of the catalogue card for the lead product.
 * Same conventions as ProductCard — porcelain frame, multiply cutout,
 * hover cue, name/tagline/price row — but shine-free and horizontal:
 * spans two columns of the three-column grid and opens to 7/5 on lg+.
 */
